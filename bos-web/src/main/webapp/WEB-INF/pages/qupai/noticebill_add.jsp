...
<body class="easyui-layout" style="visibility: hidden;">
	<div region="north" style="height: 31px; overflow: hidden;"
		...
		<div class="datagrid-toolbar">
			<a id="save" icon="icon-save" href="#" class="easyui-linkbutton"
				plain="true">新单</a> <a id="edit" icon="icon-edit"
				href="#"
	...
	<div region="center" style="overflow: auto; padding: 5px;"
		border="false">
		<form id="noticebillForm" action="NoticebillAction_add.action"
			method="post">
			<table id="mytable" class="table-edit" width="95%" align="center">
				<tr class="title">
				...
				<tr>
					...
					<td><input type="text" class="easyui-validatebox"
						name="telephone" required="true" /></td>
					<script type="text/javascript">
						$(function() {
						
                            $("input[name=telephone]").blur(function(){
                            	var telehphone=this.value;
                            	$.post("NoticebillAction_findCustomerByTelephone.action",{"telephone":telehphone},function(data){
                            		if(data!=null){
				...
				<tr>
					...
					<td colspan="3"><input type="text" class="easyui-validatebox"
						name="pickaddress" required="true" size="144" /></td>
				</tr>
				<tr>
					<td>到达城市:</td>
					<td><input type="text" class="easyui-validatebox"
				...
				<tr>
					<td>备注:</td>
					<td colspan="3"><textarea rows="5" cols="80" type="text"
							class="easyui-validatebox" name="remark" ></textarea></td>
				</tr>
			</table>
		</form>
	</div>
