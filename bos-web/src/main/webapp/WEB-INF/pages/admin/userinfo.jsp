		...
		$.post("RoleAction_findAll.action",function(data){
			for(var i=0;i<data.length;i++){
				var id = data[i].id;
					...
					$("#selectRoles").append('<input id="'+id+'" type="checkbox" name="roleIds" value="'+id+'"><label for="'+id+'">'+name+'</label>');
...
<body class="easyui-layout" style="visibility: hidden;">
	...
	<div region="center" style="overflow: auto; padding: 5px;"
		border="false">
		<form id="addUserForm" method="post" action="UserAction_add.action">
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="telephone"
						id="telephone" class="easyui-validatebox" required="true" /></td>
				</tr>
				<tr>
					<td>备注:</td>
				...
				<tr>
					<td>选择角色:</td>
					<td colspan="3" id="selectRoles"></td>
				</tr>
			</table>
		</form>
	</div>
